...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'JayChou', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || 'ysg🍚', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || '', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'JayChou,blog', // 网站关键词 英文逗号隔开
  ...
  CONTACT_GITHUB:
    process.env.NEXT_PUBLIC_CONTACT_GITHUB || 'https://github.com/guigeniubi', // 你的github个人主页 例如 https://github.com/tangly1024
  ...
  COMMENT_UTTERRANCES_REPO:
    ...
    'guigeniubi/JayChouNotionNext', // 你的代码仓库名， 例如我是 'tangly1024/NotionNext'； 更多文档参考 https://utteranc.es/

  // giscus @see https://giscus.app/
  COMMENT_GISCUS_REPO:
    process.env.NEXT_PUBLIC_COMMENT_GISCUS_REPO ||
    'guigeniubi/JayChouNotionNext', // 你的Github仓库名 e.g 'tangly1024/NotionNext'
  ...
  // 谷歌广告
  ADSENSE_GOOGLE_ID:
    process.env.NEXT_PUBLIC_ADSENSE_GOOGLE_ID || 'ca-pub-1320547532591102', // 谷歌广告ID e.g ca-pub-xxxxxxxxxxxxxxxx
  ...
  ADSENSE_GOOGLE_SLOT_IN_ARTICLE:
    process.env.NEXT_PUBLIC_ADSENSE_GOOGLE_SLOT_IN_ARTICLE || '3085879714', // Google AdScene>广告>按单元广告>新建文章内嵌广告 粘贴html代码中的data-ad-slot值
  ADSENSE_GOOGLE_SLOT_FLOW:
    process.env.NEXT_PUBLIC_ADSENSE_GOOGLE_SLOT_FLOW || '9191003508', // Google AdScene>广告>按单元广告>新建信息流广告
  ADSENSE_GOOGLE_SLOT_NATIVE:
    process.env.NEXT_PUBLIC_ADSENSE_GOOGLE_SLOT_NATIVE || '1772798048', // Google AdScene>广告>按单元广告>新建原生广告
  ADSENSE_GOOGLE_SLOT_AUTO:
    process.env.NEXT_PUBLIC_ADSENSE_GOOGLE_SLOT_AUTO || '1505204739', // Google AdScene>广告>按单元广告>新建展示广告 （自动广告）
