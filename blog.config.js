...
const BLOG = {
  ...
  NOTION_PAGE_ID:
    process.env.NOTION_PAGE_ID || '1999fe86790380e68a2cd050035b6ed1',
  ...
  CONTACT_OPENAI_API_KEY: process.env.NEXT_PUBLIC_CONTACT_OPENAI_API_KEY || '', // openai api key
  ...
  // 作废配置
  AVATAR: '/avatar.jpg', // 作者头像，被notion中的ICON覆盖。若无ICON则取public目录下的avatar.png
